...
describe("montarIndice()", () => {
  ...
  it("todo conceito do catálogo usado por alguma fase aparece no índice", () => {
    const usados = new Set(FASES.flatMap((fase) => [...fase.conceitos, ...fase.revisa, ...fase.prerequisitos]));
  ...
  it("cada fase aparece no lugar certo (ensina, pratica, revisa, pede)", () => {
    ...
    for (const entrada of indice) {
      ...
      conferir("praticam", entrada.praticam, esperado((fase) => fase.tipo === "desafio" && fase.conceitos.includes(id)));
