...
export const FASE_BANCADA_ESTILOS: FasePratica = {
  ...
  revisa: [],
  prerequisitos: [],
  usaFerramentas: ["editor-css", "painel-estilos", "editar-valor-css", "ligar-desligar-declaracao", "nova-regra"],
  apresentar: ["editor-css", "painel-estilos", "editar-valor-css", "ligar-desligar-declaracao", "nova-regra"],
